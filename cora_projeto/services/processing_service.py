    ...
    try:
        ...
        try:
            for idx, (group_key, time_tag, path) in enumerate(items, start=1):
                ...
                try:
                    results, artifacts, _adaptive_info = processor.process_item(
                        group_key=group_key,
                        time_tag=time_tag,
                        path=path,
                    ...
                    app.worker_queue.put(("item_ok", group_key, time_tag, path, results, artifacts))
                    ...
                    app.worker_queue.put(("item_error", group_key, time_tag, err_text))
